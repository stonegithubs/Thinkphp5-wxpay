...
*
* 使用建议:
* 1.首先调用 \wxpay\WxNotiy::getNotitfyData() 获取微信发送数据
* 2.其次调用 \wxpay\WxNotiy::checkNotifyData($data) 检测数据是否合法
* 3.处理自己业务逻辑
* 4.根据以上结果调用 \wxpay\WxNotiy::responseSuccess() 或者 \wxpay\WxNotiy::responseFail() 响应微信服务器;
*
* 注意:
